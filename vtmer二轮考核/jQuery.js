			...
			$.ajax({
				...
				for(var i = 0;i<4;i++)
				{
					// var title = data.bookclass[0].bookInfo[i].title;
					// console.log(data.bookclass[0].bookInfo[i].title);
					// j<data.bookclass[i+1].bookInfo.length
					for(var j = 0;j<data.bookclass[i].bookInfo.length;j++){
						// alert(j);
						// var d = data.bookclass[i].bookInfo[j].title;
						// console.log(data.bookclass[i].bookInfo[j].buyUrl[0].doubanUrl);
